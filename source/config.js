...
export const PRODUCTS = [
  {
    ...
    plans: [
      ...
      { key: "panel-unlimited", label: "UNLIMITED", ramGb: 0, cores: null, price: 10000, badge: "Request" },
    ],
    notes: [
  ...
  //     { key: "vps-2c-2g", label: "2 Core / 2GB", ramGb: 2, cores: 2, price: 11000, badge: "SG" }, // 2g2
  //     { key: "vps-2c-4g", label: "2 Core / 4GB", ramGb: 4, cores: 2, price: 14000, badge: "SG" }, // 4g2
  //     { key: "vps-4c-8g", label: "4 Core / 8GB", ramGb: 8, cores: 4, price: 15000, badge: "SG" }, // 8g4
  //     { key: "vps-4c-16g", label: "4 Core / 16GB", ramGb: 16, cores: 4, price: 16000, badge: "SG" }, // 16g4
  //     { key: "vps-8c-16g", label: "8 Core / 16GB", ramGb: 16, cores: 8, price: 17000, badge: "SG" }, // 16g8
  //   ],
  //   notes: [
...

  {
    ...
    requires: { name: true, hostname: false },
    plans: [
      { key: "admin-access", label: "Admin Access", ramGb: null, cores: null, price: 17000, badge: "Admin" },
    ],
    notes: [
...

  {
    ...
    plans: [
      { key: "reseller-access", label: "Reseller Access", ramGb: null, cores: null, price: 15000, badge: "Reseller" },
    ],
